<html>
    <head>
        ...
        if (isset($_POST['GerarGrafico'])):
            ...
            if ($GerarGraficos->totProdPorHoraAtiv($_SESSION['departamento'], $mes, $ano)) {
                echo "<script> window.location='./GraficoProdPorHoraTot.php'</script>";
            } else {
                echo "<script> alert('Não existe parada para a data selecionada.');"
                . "window.location='./GraficoProdPorHoraAtiv.php'</script>";
            }
