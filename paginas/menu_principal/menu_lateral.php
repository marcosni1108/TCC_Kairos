...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-700 mdl-color-text--white">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--white">
            <a id="home" class="mdl-navigation__link mdl-color-text--black" href="http://kairosm.esy.es/m/paginas/menu_principal/menu_principal.php"><i  class="mdl-color-text--black material-icons" role="presentation"><span >home</span></i>Inicio</a>
            ...
            <a id="planejamento" class="mdl-navigation__link mdl-color-text--black" href="#"><i class="mdl-color-text--black material-icons" role="presentation">format_list_numbered</i>Planejamento</a>
