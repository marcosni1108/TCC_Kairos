        ...
        <main class="mdl-layout__content">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <input pattern="dd/MM/yyyy" class="form-control" onchange="chamaGrafico()" id="from" name="dataDe" placeholder="Data de" autocomplete="off" readonly>                                
                    </div>

                    <div class="col-lg-2">
                        <input pattern="dd/MM/yyyy" class="form-control" onchange="chamaGrafico()" id="to" name="dataAte" placeholder="Data até" autocomplete="off" readonly>                                
                    </div>
                </div>
                <br>
                <div class="row">
