        ...
        <main class="mdl-layout__content">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <input type="date" pattern="dd/MM/yyyy" class="form-control" onchange="chamaGrafico()" id="from" name="dataDe" placeholder="Data de" autocomplete="off" required>                                
                    </div>

                    <div class="col-lg-2">
                        <input type="date" pattern="dd/MM/yyyy" class="form-control" onchange="chamaGrafico()" id="to" name="dataAte" placeholder="Data até" autocomplete="off" required>                                
                    </div>
                </div>
                <br>
                <div class="row">
